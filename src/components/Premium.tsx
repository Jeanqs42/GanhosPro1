...
import { RunRecord, AppSettings } from '../../types'; // Caminho corrigido
import { analyzeRecords, getChatFollowUp, getIntelligentReportAnalysis } from '../../services/geminiService'; // Caminho corrigido
